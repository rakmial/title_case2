...
# 1. String.title_case must be defined, and will return already capitalized words as they are.
# 2. String.title_case returns single word with uncapitalized beginning in title case
# 3. String.title_case returns multiple words in a string separated by spaces in title case
